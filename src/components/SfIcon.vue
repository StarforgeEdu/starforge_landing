...
<template>
  <svg
    ...
    aria-hidden="true"
  >
    <template v-if="name === 'arrow-up-right'">
      <path d="M7 17 17 7" />
      <path d="M8 7h9v9" />
    </template>
    ...
    <template v-else-if="name === 'phone'">
      <path d="M8.3 3.5 10 7.2 7.9 9.3a15.1 15.1 0 0 0 6.8 6.8l2.1-2.1 3.7 1.7v3a2 2 0 0 1-2 2A15.5 15.5 0 0 1 3.3 5.5a2 2 0 0 1 2-2h3Z" />
    </template>
